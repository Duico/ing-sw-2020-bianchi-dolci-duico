...
public enum CliText {
    ...
    ASK_PERSISTENCY("Do you want to load saved game? (Yes/No)"),
    ...
    BAD_YES_NO(Color.RED.escape("Type either Yes or No.")),
    CORRECT_SIGNUP_WAIT(Color.GREEN.escape("Correct signup... wait for the other players")),
    CORRECT_SIGNUP_LAST(Color.GREEN.escape("Game has started.")),
    ...
    INVALID_NICKNAME_PERSISTENCY(Color.RED.escape("This nickname was not playing the previous game. Aborting.")),
    INVALID_NUMPLAYERS(Color.RED.escape("Incorrect num of players")),
    ILLEGAL_TURN_PHASE(Color.RED.escape("Illegal turn phase")),
    ILLEGAL_FIRST_PLAYER(Color.RED.escape("Illegal first player")),
    ...
    NOT_CURRENT_WORKER(Color.RED.escape("You can't move/build from that cell")),
    NOT_CURRENT_PLAYER(Color.RED.escape("Not current player")),
    ...
    REQUIRED_MOVE(Color.RED.escape("A movement is required.")),
    REQUIRED_BUILD(Color.RED.escape("A build is required.")),
    REQUIRED_PLACE(Color.RED.escape("Place all of your workers.")),
