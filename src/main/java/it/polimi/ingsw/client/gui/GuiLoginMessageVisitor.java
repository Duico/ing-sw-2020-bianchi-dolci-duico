...
public class GuiLoginMessageVisitor extends GuiMessageVisitor {
    public GuiLoginMessageVisitor(LoginController loginController){
        ...
        super(new GuiLoginModelEventVisitor(), new GuiDefaultControllerResponseVisitor(), new GuiLoginSetUpMessageVisitor(loginController), new GuiDefaultClientConnectionEventVisitor());
    }
