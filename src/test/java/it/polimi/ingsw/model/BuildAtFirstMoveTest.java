...
class BuildAtFirstMoveTest {
        ...
        public static void before() {
                ...
                Card carta = new Card("Default", "BuildAtFirst", "Default", "Default", "Default", "Default");
        ...
        /**
         * Control if return false when we have already build and we want to move up
         * @throws PositionOutOfBoundsException
         */
        @Test
        void notValidMoveBecauseAlreadyBuild() throws PositionOutOfBoundsException {
                Turn newTurn = new Turn(partita.getPlayer(1));
                partita.setTurn(newTurn);
                startWorker.setTurn();
                Position destBuildPosition = new Position(3, 3);
                BoardCell destBuildCell = new BoardCell(destBuildPosition);
                destBuildCell.setLevel(Level.BASE);
                newTurn.getBuilds().add(destBuildCell);
        ...
        /**
         * Control if return true when we move in the correct way however we have already build
         * * @throws PositionOutOfBoundsException
         */
        @Test
        void validMoveHoweverAlreadyBuild() throws PositionOutOfBoundsException {
                Turn newTurn = new Turn(partita.getPlayer(1));
                partita.setTurn(newTurn);
                startWorker.setTurn();
                Position destBuildPosition = new Position(3, 3);
